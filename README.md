...
### 1. Main module
       *-*. import objek Flask
       *-*. Buat sebuah fungsi untuk menampung objek aplikasi, dont forget to return it
       *-*. panggil objek __main__ flask
       *-*. Buat route
       *-*. Make a function,and return what you will need i.e render template
